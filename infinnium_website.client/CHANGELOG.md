...
- Create Angular project with ng: `ng new infinnium_website.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`infinnium_website.client.esproj`).
